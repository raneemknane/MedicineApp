...
public class DeviceListAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DeviceListAdapter2(Context context, List<Object> deviceList) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        itemHolder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context,BTtemp.class);
